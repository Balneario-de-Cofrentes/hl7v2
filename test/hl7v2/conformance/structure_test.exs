defmodule HL7v2.Conformance.StructureTest do
  ...
  describe "segment catalog" do
    ...
    test "segment count is exactly 164 (152 v2.5.1 + 12 v2.6/v2.7: ARV, PRT, UAC, IAR, ITM, IVT, ILT, PKG, VND, STZ, SCP, SLT)" do
      assert Standard.segment_count() == 164
    end
  end
  ...
  describe "coverage ledger" do
    ...
    test "coverage_summary returns valid structure with exact counts" do
      ...
      # Exact counts that match README claims (152 v2.5.1 + 12 v2.6/v2.7)
      assert summary.typed_segment_count == 164
      assert summary.total_segment_count == 164
