defmodule HL7v2.Segment.FT1 do
  ...
  use HL7v2.Segment,
    ...
    fields: [
      ...
      {11, :transaction_amount_extended, HL7v2.Type.CP, :o, 1},
      {12, :transaction_amount_unit, HL7v2.Type.CP, :o, 1},
      {13, :department_code, HL7v2.Type.CE, :o, 1},
      {14, :insurance_plan_id, HL7v2.Type.CE, :o, 1},
      {15, :insurance_amount, HL7v2.Type.CP, :o, 1},
      ...
      {22, :unit_cost, HL7v2.Type.CP, :o, 1},
