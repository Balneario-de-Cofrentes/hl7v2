defmodule HL7v2.Segment.OM2 do
  ...
  10 fields per HL7 v2.5.1 specification. RFR and DLT types are
  ...
  use HL7v2.Segment,
    ...
    fields: [
      ...
      {6, :reference_normal_range_ordinal_and_continuous_observations, :raw, :o, :unbounded},
      {7, :critical_range_for_ordinal_and_continuous_observations, :raw, :o, :unbounded},
      {8, :absolute_range_for_ordinal_and_continuous_observations, :raw, :o, 1},
      {9, :delta_check_criteria, :raw, :o, :unbounded},
