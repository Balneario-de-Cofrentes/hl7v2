defmodule HL7v2.Segment.OBR do
  ...
  use HL7v2.Segment,
    ...
    fields: [
      ...
      {32, :principal_result_interpreter, HL7v2.Type.XCN, :o, 1},
      {33, :assistant_result_interpreter, HL7v2.Type.XCN, :o, :unbounded},
      {34, :technician, HL7v2.Type.XCN, :o, :unbounded},
      {35, :transcriptionist, HL7v2.Type.XCN, :o, :unbounded},
