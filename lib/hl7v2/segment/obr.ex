defmodule HL7v2.Segment.OBR do
  ...
  use HL7v2.Segment,
    ...
    fields: [
      ...
      {10, :collector_identifier, :raw, :o, :unbounded},
      ...
      {15, :specimen_source, :raw, :b, 1},
      {16, :ordering_provider, :raw, :o, :unbounded},
      ...
      {23, :charge_to_practice, :raw, :o, 1},
      {24, :diagnostic_serv_sect_id, HL7v2.Type.ID, :o, 1},
      {25, :result_status, HL7v2.Type.ID, :c, 1},
      {26, :parent_result, :raw, :o, 1},
      {27, :quantity_timing, :raw, :b, :unbounded},
      {28, :result_copies_to, :raw, :o, :unbounded},
      {29, :parent, :raw, :o, 1},
      {30, :transportation_mode, HL7v2.Type.ID, :o, 1},
      {31, :reason_for_study, HL7v2.Type.CE, :o, :unbounded},
      {32, :principal_result_interpreter, :raw, :o, 1},
      {33, :assistant_result_interpreter, :raw, :o, :unbounded},
      {34, :technician, :raw, :o, :unbounded},
      {35, :transcriptionist, :raw, :o, :unbounded},
