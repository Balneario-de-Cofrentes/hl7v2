defmodule HL7v2.Standard do
  ...
  @segment_catalog %{
    ...
    "ACC" => %{name: "Accident", tier: :unsupported},
    "ADD" => %{name: "Addendum", tier: :unsupported},
    "AIG" => %{name: "Appointment Information — General Resource", tier: :unsupported},
    "AIL" => %{name: "Appointment Information — Location Resource", tier: :unsupported},
    "AIP" => %{name: "Appointment Information — Personnel Resource", tier: :unsupported},
    ...
    "DB1" => %{name: "Disability", tier: :unsupported},
    "DRG" => %{name: "Diagnosis Related Group", tier: :unsupported},
    ...
    "IAM" => %{name: "Patient Adverse Reaction Information", tier: :unsupported},
    "IIM" => %{name: "Inventory Item Master", tier: :unsupported},
    "IN2" => %{name: "Insurance Additional Information", tier: :unsupported},
    "IN3" => %{name: "Insurance Additional Information, Certification", tier: :unsupported},
    ...
    "PD1" => %{name: "Patient Additional Demographic", tier: :unsupported},
    "PDA" => %{name: "Patient Death and Autopsy", tier: :unsupported},
    ...
    "PR1" => %{name: "Procedures", tier: :unsupported},
    ...
    "ROL" => %{name: "Role", tier: :unsupported},
    "RQ1" => %{name: "Requisition Detail-1", tier: :unsupported},
    "RQD" => %{name: "Requisition Detail", tier: :unsupported},
    "RXA" => %{name: "Pharmacy/Treatment Administration", tier: :unsupported},
    "RXC" => %{name: "Pharmacy/Treatment Component Order", tier: :unsupported},
    "RXD" => %{name: "Pharmacy/Treatment Dispense", tier: :unsupported},
    "RXE" => %{name: "Pharmacy/Treatment Encoded Order", tier: :unsupported},
    "RXG" => %{name: "Pharmacy/Treatment Give", tier: :unsupported},
    "RXO" => %{name: "Pharmacy/Treatment Order", tier: :unsupported},
    "RXR" => %{name: "Pharmacy/Treatment Route", tier: :unsupported},
    ...
    "SFT" => %{name: "Software Segment", tier: :unsupported},
    "SID" => %{name: "Substance Identifier", tier: :unsupported},
    "SPM" => %{name: "Specimen", tier: :unsupported},
    ...
    "TQ1" => %{name: "Timing/Quantity", tier: :unsupported},
    "TQ2" => %{name: "Timing/Quantity Relationship", tier: :unsupported},
  ...
  @type_catalog %{
    ...
    "RI" => %{name: "Repeat Interval", category: :composite, tier: :unsupported},
    "RMC" => %{name: "Room Coverage", category: :composite, tier: :unsupported},
    "RP" => %{name: "Reference Pointer", category: :composite, tier: :unsupported},
    "RPT" => %{name: "Repeat Pattern", category: :composite, tier: :unsupported},
