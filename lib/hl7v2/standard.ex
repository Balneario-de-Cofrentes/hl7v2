defmodule HL7v2.Standard do
  ...
  @typed_segment_modules %{
    ...
    "ITM" => HL7v2.Segment.ITM,
    "IVT" => HL7v2.Segment.IVT,
  ...
  @segment_catalog %{
    ...
    "ARV" => %{name: "Access Restriction", tier: :typed},
    ...
    "IAR" => %{name: "Allergy Reaction", tier: :typed},
    "IIM" => %{name: "Inventory Item Master", tier: :typed},
    "ILT" => %{name: "Material Lot (v2.6)", tier: :typed},
    ...
    "ITM" => %{name: "Material Item Master (v2.6)", tier: :typed},
    "IVT" => %{name: "Material Location (v2.6)", tier: :typed},
    ...
    "PKG" => %{name: "Item Packaging (v2.6)", tier: :typed},
    ...
    "PRT" => %{name: "Participation Information", tier: :typed},
    ...
    "SCP" => %{name: "Sterilizer Configuration (v2.6)", tier: :typed},
    "SDD" => %{name: "Sterilization Device Data (v2.6)", tier: :typed},
    "SID" => %{name: "Substance Identifier", tier: :typed},
    "SLT" => %{name: "Sterilization Lot (v2.6)", tier: :typed},
    ...
    "STZ" => %{name: "Sterilization Parameter (v2.6)", tier: :typed},
    ...
    "UAC" => %{name: "User Authentication Credential", tier: :typed},
    ...
    "VND" => %{name: "Purchasing Vendor (v2.6)", tier: :typed},
